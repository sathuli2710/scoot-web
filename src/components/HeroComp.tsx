...
const HeroComp = () => {
  return (
    <div className="relative">
      <div className="bg-[url('/Users/abul.a/Desktop/Learn/scoot-web/src/assets/heroimage.png')] bg-fixed bg-bottom bg-cover bg-no-repeat px-[100px] py-[150px] before:content-[''] before:absolute before:inset-0 before:bg-black before:bg-opacity-60">
